...
Combination therapy?
---------------------------------------
DIY: Cancer Crusade game for Android and iOS

(http://cancercrusadegame.com/)

<div style="margin-top: 0px; margin-bottom: -10px; display: flex; flex-direction: row; font-size: .8em; text-align: center">
  <div><img width="200px" src="images/Slide1.png"></div>
  <div><img width="200px" src="images/Slide2.png"></div>
  <div><img width="200px" src="images/Slide5.png"></div>
  <div><img width="200px" src="images/Slide6.png"></div>
</div>

<blockquote style="display:block; width:100%; font-size:.75em; margin-top:20px">
Data generated by thousands of users will be sent back to the Moffitt Cancer Center in Tampa, Florida and analyzed for new and improved therapeutic schedules. Join the fight against cancer!
</blockquote>
